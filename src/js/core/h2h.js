...
/**
 * Analyser les H2H pour une équipe ciblée.
 *
 * @param {Array}  h2h          — liste des matchs H2H
 * @param {string} equipeNom    — nom de l'équipe ciblée
 * @param {number} minH2H       — nb minimum pour appliquer le filtre (défaut 3)
 * @returns {Object}            — résultat d'analyse H2H
 */
...
/**
 * Formater les données H2H pour l'affichage en timeline.
 * Retourne les 5 derniers matchs formatés.
 *
 * @param {Array} h2h
...
/**
 * Résumé court H2H pour les badges de cartes.
 */
